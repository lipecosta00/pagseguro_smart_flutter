...
enum PaymentTypeCall { CREDIT, CREDIT_PARC, DEBIT, PIX, VOUCHER, ABORT, LAST_TRANSACTION, REFUND, ACTIVEPINPAD, PINPAD_AUTHENTICATED, READ_NFC, WRITE_NFC, REWRITE_NFC, REFUND_NFC, DEBIT_NFC, FORMAT_NFC, PRINTER_FILE, START_PAYMENT, PRINTER, PRINTER_BASIC, PRINTER_FILE_PATH, REBOOT, BEEP, GET_SUB_ACQUIRER_DATA, GET_USER_DATA }
  ...
  get method {
    switch (this) {
      ...
      case PaymentTypeCall.BEEP:
        return 'paymentBeep';
      case PaymentTypeCall.GET_SUB_ACQUIRER_DATA:
        return 'getSubAcquirerData';
      case PaymentTypeCall.GET_USER_DATA:
        return 'getUserData';
    }
  }
}
